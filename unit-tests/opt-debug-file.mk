...
DEBUG_OUTPUT:=	${:!type opt-debug-file.debuglog!}
...
.if !${:!type opt-debug-file.debuglog!:tW:M*VAR = value $${:Uexpanded}*}
.  error
.endif
...
.if ${:!type opt-debug-file.debuglog!:Maddition:[#]} != 1
.  error
.endif
...
.MAKEFLAGS: -dFstderr -d0c
.if ${:!type opt-debug-file.debuglog!:Mdelimiter:[#]} != 1
.  error
.endif
