...
# temporary file if -dn is specified. In chains of dependencies,
# these files would end up empty. Since job.c 1.399 from 2021-01-29,
# these empty files are no longer created.
#
