...
all:
	@echo direct compat
	@set MAKEFLAGS= & ${MAKE} -r -f ${MAKEFILE} -k direct& echo exited !errorlevel!
	@echo:

	@echo direct jobs
	@set MAKEFLAGS= & ${MAKE} -r -f ${MAKEFILE} -k direct -j1& echo exited !errorlevel!
	@echo:

	@echo indirect compat
	@set MAKEFLAGS= & ${MAKE} -r -f ${MAKEFILE} -k indirect& echo exited !errorlevel!
	@echo:

	@echo indirect jobs
	@set MAKEFLAGS= & ${MAKE} -r -f ${MAKEFILE} -k indirect -j1& echo exited !errorlevel!
	@echo:
